...
export function FilterSidebar({ resultCount }: { resultCount: number }) {
  ...
  const maxPriceConverted = Math.ceil(convertFromDZD(maxPriceDZD)) || 50000;

  const [priceRange, setPriceRange] = useState([
    convertFromDZD(1000) || 1000,
    convertFromDZD(25000) || 25000,
  ]);
        ...
        >
          ...
          <AccordionItem value="popular">
            ...
            <AccordionContent className="p-4 pt-0 space-y-3">
              {["Piscine", "Wifi", "Parking", "Climatisation", "Vue sur la mer"].map(
                (item) => (
                  <div key={item} className="flex items-center space-x-2">
                    <Checkbox id={`pop-${item}`} />
                    <Label htmlFor={`pop-${item}`} className="font-normal">
                      {item}
                    </Label>
                  </div>
                )
            ...
            <AccordionContent className="p-4 pt-0">
              <RadioGroup defaultValue="any" className="space-y-2 mt-2">
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="r-any" className="font-normal">
                    Tous
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="r-9" className="font-normal">
                    Fabuleux : 9+
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="r-8" className="font-normal">
                    Très bon : 8+
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="r-7" className="font-normal">
                    Bon : 7+
                  </Label>
                </div>
              </RadioGroup>
            ...
            <AccordionContent className="p-4 pt-0 space-y-3">
              {mealOptions.map((item) => (
                <div key={item} className="flex items-center space-x-2">
                  ...
                  <Label htmlFor={`meal-${item}`} className="font-normal">
                    {item}
                  </Label>
                </div>
              ))}
            ...
            <AccordionContent className="p-4 pt-0 space-y-3">
              {facilityAmenities.map((item) => (
                <div key={item} className="flex items-center space-x-2">
                  ...
                  <Label htmlFor={`fac-${item}`} className="font-normal">
                    {item}
                  </Label>
                </div>
              ))}
            ...
            <AccordionContent className="p-4 pt-0 space-y-3">
              {placesOfInterest.map((item) => (
                <div key={item} className="flex items-center space-x-2">
                  ...
                  <Label htmlFor={`poi-${item}`} className="font-normal">
                    Distance de/du : {item}
                  </Label>
                </div>
              ))}
          ...
          {/* Caractéristiques les mieux notées */}
